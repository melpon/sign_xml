defmodule SignXMLTest do
  ...
  @aleksey_xmldsig_01 [
    # todo cases
    {"enveloping-dsa-x509chain.xml", :error, []},
    # error: expired
    {"enveloping-expired-cert.xml", :error, []},
    # error: md5
    {"enveloping-md5-hmac-md5-64.xml", :error, @hmac_opts},
    # error: md5
    {"enveloping-md5-hmac-md5.xml", :error, @hmac_opts},
    # error: md5
    {"enveloping-md5-rsa-md5.xml", :error, @rsa_opts},
    # error: ripemd160
    {"enveloping-ripemd160-hmac-ripemd160-64.xml", :error, @hmac_opts},
    # error: ripemd160
    {"enveloping-ripemd160-hmac-ripemd160.xml", :error, @hmac_opts},
    # error: ripemd160
    {"enveloping-ripemd160-rsa-ripemd160.xml", :error, @rsa_opts},
    {"enveloping-rsa-x509chain.xml", :ok, @rsa_opts},
    # error: "HMACOutputLength" in sig.decode("utf-8")
    {"enveloping-sha1-hmac-sha1-64.xml", :error, @hmac_opts},
    {"enveloping-sha1-hmac-sha1.xml", :ok, @hmac_opts},
    {"enveloping-sha1-rsa-sha1.xml", :ok, @rsa_opts},
    # error: "HMACOutputLength" in sig.decode("utf-8")
    {"enveloping-sha224-hmac-sha224-64.xml", :error, @hmac_opts},
    {"enveloping-sha224-hmac-sha224.xml", :ok, @hmac_opts},
    {"enveloping-sha224-rsa-sha224.xml", :ok, @rsa_opts},
    # error: "HMACOutputLength" in sig.decode("utf-8")
    {"enveloping-sha256-hmac-sha256-64.xml", :error, @hmac_opts},
    {"enveloping-sha256-hmac-sha256.xml", :ok, @hmac_opts},
    {"enveloping-sha256-rsa-sha256.xml", :ok, @rsa_opts},
    # error: "HMACOutputLength" in sig.decode("utf-8")
    {"enveloping-sha384-hmac-sha384-64.xml", :error, @hmac_opts},
    {"enveloping-sha384-hmac-sha384.xml", :ok, @hmac_opts},
    {"enveloping-sha384-rsa-sha384.xml", :ok, @rsa_opts},
    # error: "HMACOutputLength" in sig.decode("utf-8")
    {"enveloping-sha512-hmac-sha512-64.xml", :error, @hmac_opts},
    {"enveloping-sha512-hmac-sha512.xml", :ok, @hmac_opts},
    {"enveloping-sha512-rsa-sha512.xml", :ok, @rsa_opts},
    # unsupported cases
    {"x509data-sn-test.xml", :error, []},
    # unsupported cases
    {"x509data-test.xml", :error, []},
    # unsupported cases
    {"xpointer-hmac.xml", :error, []}
  ]
  ...
  @phaos_xmldsig_three [
    # todo case
    {"signature-big.xml", :error, @opts},
    # expired
    {"signature-dsa-detached.xml", :error, @opts},
    # expired
    {"signature-dsa-enveloped.xml", :error, @opts},
    # expired
    {"signature-dsa-enveloping.xml", :error, @opts},
    # {"signature-dsa-manifest.xml", :ok, @opts}, # ???
    # md5 not supported
    {"signature-hmac-md5-c14n-enveloping.xml", :error, @opts},
    # length
    {"signature-hmac-sha1-40-c14n-comments-detached.xml", :error, @opts},
    # length
    {"signature-hmac-sha1-40-exclusive-c14n-comments-detached.xml", :error, @opts},
    ...
    # Digest mismatch for reference 0
    {"signature-rsa-detached-xpath-transform.xml", :error, @opts},
    ...
    {"signature-rsa-detached-xslt-transform-retrieval-method.xml", :error, @opts},
    # {"signature-rsa-detached-xslt-transform.xml", :ok, @opts}, # ???
    # expired
    {"signature-rsa-detached.xml", :error, @opts},
    {"signature-rsa-enveloped-bad-digest-val.xml", :error, @opts},
    {"signature-rsa-enveloped-bad-sig.xml", :error, @opts},
    # expired
    {"signature-rsa-enveloped.xml", :error, @opts},
    # expired
    {"signature-rsa-enveloping.xml", :error, @opts},
    # expired
    {"signature-rsa-manifest-x509-data-cert-chain.xml", :error, @opts},
    # expired
    {"signature-rsa-manifest-x509-data-cert.xml", :error, @opts},
    # unsupported
    {"signature-rsa-manifest-x509-data-issuer-serial.xml", :error, @opts},
    # unsupported
    {"signature-rsa-manifest-x509-data-ski.xml", :error, @opts},
    # unsupported
    {"signature-rsa-manifest-x509-data-subject-name.xml", :error, @opts},
    # unsupported
    {"signature-rsa-manifest-x509-data.xml", :error, @opts},
    # {"signature-rsa-manifest.xml", :ok, @opts}, # ???
    # expired
    {"signature-rsa-xpath-transform-enveloped.xml", :error, @opts}
  ]
  ...
  @xml_crypto [
    {"signature_with_inclusivenamespaces.xml", :ok,
     [ca_pem_file: "test/interop/xml-crypto/signature_with_inclusivenamespaces.pem"]}
